...
- SMS parsing for UAE banks first (FAB, ENBD, Liv, ADCB, Mashreq, Emirates Islamic), plus <!-- BANKS_SUMMARY -->153 banks across 23 countries<!-- /BANKS_SUMMARY -->
...
- Follows Android light/dark and Material You wallpaper colors on first run (branded rose/cream is optional in Appearance)
